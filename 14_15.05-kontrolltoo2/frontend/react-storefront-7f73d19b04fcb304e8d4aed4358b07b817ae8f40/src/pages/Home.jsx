...
function Home() {
  ...
  const CATEGORIES_API_URL = import.meta.env.VITE_BACK_URL + "/categories"
  ...
  return (
    <div className="flex flex-col gap-6 pt-4">
      ...
      <div className="flex items-center gap-2">
        <Button onClick={() => setPage(page - 1)} disabled={page === 0} variant="outline">Eelmine</Button>
        <span>Lehekülg {totalPages === 0 ? 0 : page + 1} / {totalPages}</span>
        <Button onClick={() => setPage(page + 1)} disabled={page + 1 >= totalPages} variant="outline">Järgmine</Button>
      </div>
